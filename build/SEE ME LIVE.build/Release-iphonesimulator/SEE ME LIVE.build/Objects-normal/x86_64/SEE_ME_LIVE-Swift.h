...
#ifndef SEE_ME_LIVE_SWIFT_H
#define SEE_ME_LIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SEE_ME_LIVE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSDate;
@class NSData;
@interface Show (SWIFT_EXTENSION(SEE_ME_LIVE))
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, copy) NSString * _Nullable role;
@property (nonatomic, copy) NSString * _Nullable venue;
@property (nonatomic, copy) NSDate * _Nullable date;
@property (nonatomic) double price;
@property (nonatomic, copy) NSString * _Nullable ticketLink;
@property (nonatomic, copy) NSString * _Nullable notes;
@property (nonatomic, copy) NSData * _Nullable flyerImageData;
@property (nonatomic, copy) NSString * _Nullable calendarEventID;
@property (nonatomic, copy) NSString * _Nullable publicRecordID;
@property (nonatomic, copy) NSString * _Nullable userID;
@property (nonatomic) BOOL addToCalendar;
@property (nonatomic) BOOL setReminder;
@property (nonatomic) BOOL needsPublicSync;
@property (nonatomic) BOOL pendingPublicDelete;
@property (nonatomic, copy) NSString * _Nullable lastPublicSyncError;
